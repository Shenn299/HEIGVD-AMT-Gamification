...
public class EventsEndpoint implements EventsApi {
   ...
   public ResponseEntity<LocationEvent> eventsPost(@RequestHeader("Authorization") String authenticationToken, @RequestBody EventInputDTO event) {
      ...
      newEvent.setUserAppId(userAppId);
      newEvent.setApplication(application);
      userInDb = eventProcessor.processEvent(application, newEvent);
