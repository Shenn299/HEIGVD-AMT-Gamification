...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/events/eventsModule.js',
			'app/modules/events/eventsCtrl.js',
			'app/modules/events/eventsRoute.js',
			'app/modules/events/eventsService.js',
			'app/modules/events/events-test.js',
			...
			'app/modules/managelocalstorage/managelocalstorageModule.js',
			'app/modules/managelocalstorage/managelocalstorageCtrl.js',
